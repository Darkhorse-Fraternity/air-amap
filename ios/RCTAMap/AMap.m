...
- (void) updateMap {
    if (_mapView) {
        ...
        if (!_initialRegionSet) {
            ...
            self.mapView.userTrackingMode = _userTrackingMode;
            self.mapView.rotateEnabled = _rotateEnabled;
...
- (MAAnnotationView *)mapView:(__unused MAMapView *)mapView viewForAnnotation:(AMapMarker *)marker
{
    ...
    if ([marker isKindOfClass:[MAUserLocation class]])
    {
        static NSString *userLocationStyleReuseIndetifier = @"userLocationStyleReuseIndetifier";
        MAAnnotationView *annotationView = [mapView dequeueReusableAnnotationViewWithIdentifier:userLocationStyleReuseIndetifier];
        if (annotationView == nil)
        {
            annotationView = [[MAPinAnnotationView alloc] initWithAnnotation:marker
                                                             reuseIdentifier:userLocationStyleReuseIndetifier];
        }
        
        annotationView.image = [UIImage imageNamed:@"userPosition.png"];
...
//    self.mapView.headingFilter = userLocation.heading;
    ...
    if(self.onUpdateUserLocation ){
        self.onUpdateUserLocation(@{
...
MAP_PROP_UPDATE(BOOL, rotateEnabled);
...
MAP_PROP_UPDATE(MAUserTrackingMode, userTrackingMode)
